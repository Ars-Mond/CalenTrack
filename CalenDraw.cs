...
namespace CalenTrack
{
    class CalenDraw
    {
        ...
        public static PictureBox canvasEl
        {
            get => MainForm.inst.canvas;
        }
        ...
        public static Bitmap ensureSize()
        {
            ...
            if (canvas.Width <= 0) return bitmap;
                ...
                foreach (var hour in CalenCore.hours)
                {
                    ...
                    else
                    {
                        ...
                        if (startHere)
                        {
                            ...
                            {
                                drawFillRectBetween(selectPen, selectBrush, tickStartX, tickStartY, hourRight,
                                    tickStartY + scale);
                                drawFillRectBetween(selectPen, selectBrush, hourX, tickEndY - scale, tickEndX,
                                    tickEndY);
                            }
                            else
                            {
                                ...
                                {
                                    fillRectBetween(selectBrush, hourX, tickStartY + scale, hourRight,
                                        tickEndY - scale);
                                }
